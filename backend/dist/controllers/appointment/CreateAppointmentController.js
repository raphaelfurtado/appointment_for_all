...
const CreateAppointmentService_1 = require("../../services/appointment/CreateAppointmentService");
class CreateAppointmentController {
    handle(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const createAppointmentService = new CreateAppointmentService_1.CreateAppointmentService();
