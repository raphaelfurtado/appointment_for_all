...
const CreateService_1 = require("../../services/service/CreateService");
class CreateServiceController {
    handle(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const createService = new CreateService_1.CreateService();
            const category = yield createService.execute({
                name,
                description,
                price,
                duration,
